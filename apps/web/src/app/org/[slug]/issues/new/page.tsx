...
import type { Doc, Id } from "@better-issues/backend/convex/_generated/dataModel";
import type { TemplateSchema } from "@better-issues/backend/convex/lib/templateSchema";
